    ...
    private $_method = array();
	    ...
	    public function submit(){
			...
			if(empty($_SESSION['User'])){
				...
				if($secciones_Valida_Session == "profile_user" || $secciones_Valida_Session == "edu-articulo-curso" || $secciones_Valida_Session == "edu_articulo_sugerencia" || $secciones_Valida_Session == "recuperar-password" || $secciones_Valida_Session == "api_user"){
