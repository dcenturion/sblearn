				...
				switch ($Obj) {
					...
					case "Edu_Certificado_Digital_Participante":
                            ...
                            // DCWrite(Message(" tipo_producto  ".$tipo_producto." interfaceraiz  ".$interfaceraiz,"C"));
							 DCWrite(Message("El Id_Tipo_Certificado ".$Id_Tipo_Certificado."","C"));
                            if($Id_Tipo_Certificado == 2){
								   ...
								   }elseif($interfaceraiz  == "mostrarcertificado"){
									   
									    $Settings = array();
										$Settings['Url'] = "/sadministrator/edu-certificado/interface/List_Visor/key/".$Id_Edu_Almacen."/Id_Edu_Certificado/".$Id_Edu_Certificado."/tipo-producto/programa/interfaceraiz/".$interfaceraiz."";
        ...
        switch ($interface) {
            ...
            case "List":
				...
				if(!empty($Id_Edu_Certificado)){
                    ...
                    $ImagenQr = $Row->ImagenQr;		
                    $Codigo_Generado_Automatico = $Row->Codigo_Generado_Automatico;		
                    $Date_Time_Creation_Certificado = $Row->Date_Time_Creation;		
					...
					$Query = "
					SELECT EGC.Id_Suscripcion, EGC.Nota
					, EGC.Estado_Academico  
					, EGC.Id_Edu_Tipo_Titulo  
					FROM 
					edu_certificado EGC
					...
					$Id_Edu_Tipo_Titulo = $Rows->Id_Edu_Tipo_Titulo;
					
					
					$Query = "
					SELECT EGC.Id_Edu_Tipo_Titulo  FROM 
					programa_cab EGC
					WHERE EGC.Id_Programa_Cab = :Id_Programa_Cab 
					";
					$Where = ["Id_Programa_Cab" => $Id_Edu_Almacen];
					$Rows = ClassPdo::DCRow($Query,$Where,$Conection);					
					$Id_Edu_Tipo_Titulo_PC = $Rows->Id_Edu_Tipo_Titulo;					
						...
						foreach($Rows AS $Field){
							...
							$Id_Suscripcion_Curso = $RowB->Id_Suscripcion_Curso;								
					...
					// $Codigo_Generado_Automatico
						...
						if( $Date_Time_Creation_Certificado <= "2023-10-12"){
							
							   
							$Codigo_Certificado = $Id_Edu_Almacen."_".$Id_Edu_Pais."_".$Numero_Identidad."_".$Modalidad_Curso;
							$ImagenQr_Img = "ImgQr_".$Id_Edu_Almacen."_".$Id_Edu_Pais."_".$Numero_Identidad."_".$Modalidad_Curso;
								
								
						}else{
				
							
							if( empty($Codigo_Generado_Automatico)){
								
									$Codigo_Certificado = $Id_Edu_Certificado."_".$Id_Edu_Almacen."_".$Id_Edu_Pais."_".$Numero_Identidad."_".$Modalidad_Curso;
									$ImagenQr_Img = "ImgQr_".$Id_Edu_Certificado."_".$Id_Edu_Almacen."_".$Id_Edu_Pais."_".$Numero_Identidad."_".$Modalidad_Curso;
																		
											
									$Reg = array(
									'Codigo_Generado_Automatico' => $Codigo_Certificado,
									);
									$Where = array('Id_Edu_Certificado' => $Id_Edu_Certificado);
									$rg = ClassPDO::DCUpdate('edu_certificado', $Reg , $Where, $Conection);
								...
								$Codigo_Certificado = $Codigo_Generado_Automatico;
					...
					if($Estado_Academico == "aprobado"){
						...
						if( $Id_Perfil_Educacion == 1){
							...
							if( $Id_Edu_Tipo_Titulo_PC == 1){
								
							    if( $Id_Edu_Tipo_Titulo == 2){
									   $Tipo_Constancia = "CERTIFICADO";
								}else{
									   $Tipo_Constancia = "DIPLOMADO";
									   $Tipo_Prdoducto_desc = "Diplomado";	
								}
							}else{
								$Tipo_Constancia = "CERTIFICADO";
							}
				...
				if(empty($ImagenQr)){
					...
					$Reg = array(
					'Codigo_Sistema' => $Codigo_Certificado,
					'ImagenQr' => $ImagenQr_Img
					);
					$Where = array('Id_Edu_Certificado' => $Id_Edu_Certificado);
					$rg = ClassPDO::DCUpdate('edu_certificado', $Reg , $Where, $Conection);
					...
					$Codigo_CertificadoUrl = DCEncriptar($Codigo_Certificado);
					
					
		
					$imgQRA = $qr_code->generate($Dominio."certificado/empresa/".$Url."/interface/ListDet/request/on?key=".$Codigo_CertificadoUrl."",$ImagenQr_Img,"230");
					$ImagenQr = $ImagenQr_Img;

				}	

                $RamdonImg  = rand();				
				$TagImg = " <img src='".$Dominio."sbookstores/php/qr/img_qr/".$ImagenQr.".png?v=".$RamdonImg."' style='width:100px;' >";					
				...
				if($tipo_descarga == "c_fisico" && $Modalidad_Venta_Curso == "En_Vivo"){
					...
					$Firma_Hmtl_1 = "<img src='".$Dominio."sadministrator/simages/".$Certificado_Firma_1."' style='width:200px;'>";
					$Firma_Hmtl_2 = "<img src='".$Dominio."sadministrator/simages/".$Certificado_Firma_2."' style='width:200px;'>";					
				}
			    ...
			    $Html ="
					...
					style='background-image: url(".$Dominio."sadministrator/simages/".$Certificado_Imagen.");background-repeat:no-repeat;background-size:900px 700px;' >
								...
								<table>
									  <tr>
										...
										<td style='width:300px;padding:60px 0px 0px 0px;'>
										    <img src='".$Dominio."sadministrator/simages/".$Logo_Certificado_2."' style='width:280px;'>
										</td>
										<td style='width:300px;padding:60px 0px 0px 0px;'> 
										    <img src='".$Dominio."sadministrator/simages/".$Logo_Certificado_1."' style='width:250px;'>
										</td>										
									  </tr>
				               ...
				               <table>
									  <tr>
										...
										<td style='width:150px;padding:40px 0px 0px 40px;'> 
										    ...
										    <img src='".$Dominio."sadministrator/simages/".$Certificado_Sello_1."' style='width:150px;'>
	                            ...
	                            <table>
									  <tr>
										<td style='width:700px;padding-left:40px'>
										   ".$TagImg."
										</td>
            ...
            case "List_Visor":
				...
				if( $interfaceraiz == "mostrarcertificado" ){
					
					$Query="  
					SELECT PC.Nombre,PC.Id_Programa_Cab,PC.Imagen_Programa 
					...
					GROUP BY PC.Id_Programa_Cab
					";
					$Where = ["Entity"=>$Entity,"Id_Programa_Cab"=>$Id_Edu_Almacen];
					$Card = "";
					$Row = ClassPdo::DCRow($Query,$Where,$Conection);
					$Nombre=$Row->Nombre;
					$Url_Amigable = DCUrl_Amigable($Nombre);					
					
					 $btn = " Volver Atrás ]/sadministrator/edu-programa/Interface/begin/programa/".$Url_Amigable."/request/on]]HREF]btn btn-primary ladda-button}";					   
				}else{
