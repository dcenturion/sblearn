...
class informacionPago{
    ...
    public  function __construct($_parm=null)
    {
		...
		echo $layout->main($this->viewHome($empresa,$pedido,$datosUser,$cod_cliente,$mensaje,$cnOwlPDO),$datos);

    }



    public function viewHome($empresa,$pedido,$datosUser,$cod_cliente,$mensaje,$cnOwlPDO) {
		...
		$Query = " 
		SELECT 
		MAX(PFC.Codigo) AS PenultimaPropuesta
		, PFC.Provincia
		, PFC.Ciudad
		, PFC.Direccion
		, PFC.Pais
        ...
        $datos['publicKey'] = "pk_test_cAfDcaAK78G7hDVh";
