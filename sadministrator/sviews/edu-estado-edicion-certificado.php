...
class Edu_Estado_Edicion_Certificado{
    ...
    public  function __construct($Parm=null)
	{
		...
		$UrlFile = "/sadministrator/edu-estado-edicion-certificado";
        ...
        switch ($Process) {
            case "ENTRY":
				...
				switch ($Obj) {
					case "Edu_Estado_Edicion_Certificado_Crud":
					
                            $Data = array();
							$Data['Id_Pedido_Cab'] = $Parm["Id_Pedido"];						
							$Data['Total'] = DCPost("Cantidad") * DCPost("Precio");						
						    // DCCloseModal();									
							DCSave($Obj,$Conection,$Parm["Id_Edu_Estado_Edicion_Certificado"],"Id_Edu_Estado_Edicion_Certificado",$Data);  
							
							$Settings["interface"] = "List";
							// $Settings["REDIRECT"] = $Redirect;
							// $Settings["Id_Pedido"] = $Parm["Id_Pedido"];
							new Edu_Estado_Edicion_Certificado($Settings);
							DCExit();	
        ...
        switch ($interface) {
            ...
            case "List":
				...
				$Query = "
				    SELECT PB.Id_Edu_Estado_Edicion_Certificado AS CodigoLink, PB.Nombre, PB.Alias, PB.Date_Time_Creation FROM edu_estado_edicion_certificado PB
				";    
				$Class = 'table table-hover';
				$LinkId = 'Id_Edu_Estado_Edicion_Certificado';
            ...
            case "Create":
	            ...
	            $Id_Edu_Estado_Edicion_Certificado = $Parm["Id_Edu_Estado_Edicion_Certificado"];
				$DirecctionA = $UrlFile."/Process/ENTRY/Obj/Edu_Estado_Edicion_Certificado_Crud/Id_Edu_Estado_Edicion_Certificado/".$Id_Edu_Estado_Edicion_Certificado;
				$DirecctionDelete = $UrlFile."/interface/DeleteMassive/Id_Edu_Estado_Edicion_Certificado/".$Id_Edu_Estado_Edicion_Certificado;
				
				if(!empty($Id_Edu_Estado_Edicion_Certificado)){
				    $Name_Interface = "Editar Componente";				    	
				    $Name_Button = "<i class='zmdi zmdi-check zmdi-hc-fw'></i> Actualizar";
                    $ButtonAdicional = array("<i class='zmdi zmdi-delete zmdi-hc-fw'></i> Eliminar",$DirecctionDelete,"animatedModal5","Form","Edu_Estado_Edicion_Certificado_Crud","btn btn-default m-w-120");					
				}else{
				...
				$Buttons = array(
				     array($Name_Button,$DirecctionA,"animatedModal5","Form","Edu_Estado_Edicion_Certificado_Crud"),$ButtonAdicional
				);	
		        $Form1 = BFormVertical("Edu_Estado_Edicion_Certificado_Crud",$Class,$Id_Edu_Estado_Edicion_Certificado,$PathImage,$Combobox,$Buttons,"Id_Edu_Estado_Edicion_Certificado");
            ...
            case "DeleteMassive":
				...
				$btn = "Continue ]" .$UrlFile ."/Process/DELETE/Id_Edu_Estado_Edicion_Certificado/".$Id_Edu_Estado_Edicion_Certificado."/Obj/Edu_Estado_Edicion_Certificado_Crud]animatedModal5]HXMS]]btn btn-default dropdown-toggle]}";				
	...
	public function ObjectDelete($Settings) {
		...
		$Id_Edu_Estado_Edicion_Certificado = $Settings["Id_Edu_Estado_Edicion_Certificado"];
			
		$where = array('Id_Edu_Estado_Edicion_Certificado' =>$Id_Edu_Estado_Edicion_Certificado);
		$rg = ClassPDO::DCDelete('edu_estado_edicion_certificado', $where, $Conection);
