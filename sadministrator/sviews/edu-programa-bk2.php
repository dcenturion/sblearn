        ...
        switch ($Interface) {
            case "begin":
				...
				$Query = "
						...
						WHERE 
						SUS.Id_User = :Id_User AND SUS.Visibilidad=:Estado AND  SUS.Entity =:Entity AND PD.Id_Programa_Cab=:Id_Programa_Cab
						ORDER BY AR.Date_Time_Creation DESC
						";    
					$Where = ["Id_User"=>$User,"Entity"=>$Entity,"Estado"=>"Activo","Id_Programa_Cab"=>$Id_Programa_Cab];
