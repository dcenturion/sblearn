...
class Edu_Tendencia{
    ...
    public  function __construct($Parm=null)
	{
		...
		$UrlFile = "/sadministrator/edu-tendencia";
        ...
        switch ($Interface) {
            case "":
				...
				$DCPanelTitle = DCPanelTitle("Tendencia","",$btn,"");
					
				$Card = Biblioteca::Articulos($Parm,"Tendencia");
				...
				$Plugin .= DCMarca_Menu("li_btn_tendencia");
				
				$Contenido = DCPage($DCPanelTitle , $Pestanas . $Html .  $Plugin ,"panel panel-default");
				// $Contenido = "HAHAH";
				
				if($Parm["request"] == "on"){
					DCWrite($layout->main($Contenido,$Parm));
				}else{
					DCWrite($Contenido);			
				}
