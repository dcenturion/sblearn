        ...
        switch ($Interface) {
            case "":
				...
				$Id_Perfil_Educacion = $Row->Id_Perfil_Educacion;
					...
					$IMG_LIST= 'OJZ5WQO5GMLIH5EX0HVY_PROGRAMAS.png';
					...
					$Query="  
							  ...
							  WHERE 
							  PA.Id_User = :User  AND PA.Entity = :Entity 
					...
					foreach($Row AS $Field){
						...
						// var_dump($Url_Amigable);
						
						$Imagen_Programa=$Field->Imagen_Programa;
						
						if (empty($Imagen_Programa)) {
							
							$Imagen_FIELD=$IMG_LIST;
							
						}else{ 
						
						    $Imagen_FIELD=$Imagen_Programa;
						
						}
						
						// if($Id_Perfil_Educacion == 4){
							
							// $IMG_LIST='OJZ5WQO5GMLIH5EX0HVY_MEMBRESIA.png';
							// $TITULO_LIST='MEMBRESÍA';
							
							// $Card .='<div class="col-md-3">
									  // <div class="c-product" style="Position:relative;">
											// <a class="cp-img" style="background-image: url(/sadministrator/simages/articulo/'.$IMG_LIST.')" href="/sadministrator/edu-articulo-programa/interface/Programa-Det/request/on">
											// </a>
						...
						$Card .= '<div class="col-md-3">
								  <div class="c-product" style="Position:relative;">
										<a class="cp-img" style="background-image: url(/sadministrator/simages/articulo/'.$Imagen_FIELD.')" 
										href="/sadministrator/edu-programa/Interface/begin/programa/'.$Url_Amigable.'/request/on">
										</a>
									  <div class="cp-content">
										  <div class="cp-title">
											'.$Nombre.'						
