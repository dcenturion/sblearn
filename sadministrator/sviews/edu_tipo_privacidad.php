...
class Edu_Tipo_Privacidad{
    ...
    public  function __construct($Parm=null)
	{
		...
		$UrlFile = "/sadministrator/edu-tipo-privacidad";
        ...
        switch ($interface) {
            ...
            case "List":
				...
				$Query = "
				    SELECT PB.Id_Edu_Tipo_Privacidad AS CodigoLink, PB.Nombre, PB.Date_Time_Creation FROM edu_tipo_privacidad PB
				";    
				$Class = 'table table-hover';
				$LinkId = 'Id_Edu_Tipo_Privacidad';
            ...
            case "Create":
				...
				$DirecctionA = $UrlFile."/REDIRECT/".$Redirect."/Process/ENTRY/Obj/Edu_Tipo_Privacidad_Crud/Id_Edu_Tipo_Privacidad/".$Id_Edu_Tipo_Privacidad;
				$DirecctionDelete = $UrlFile."/REDIRECT/".$Redirect."/interface/DeleteMassive/Id_Edu_Tipo_Privacidad/".$Id_Edu_Tipo_Privacidad;
				
				if(!empty($Id_Edu_Tipo_Privacidad)){
				    $Name_Interface = "Editar Formato";				    	
				    $Name_Button = "<i class='zmdi zmdi-check zmdi-hc-fw'></i> Actualizar";
                    $ButtonAdicional = array("<i class='zmdi zmdi-delete zmdi-hc-fw'></i> Eliminar",$DirecctionDelete,"animatedModal5","Form","Edu_Tipo_Privacidad_Crud","btn btn-default m-w-120");					
				}else{
				...
				$Buttons = array(
				     array($Name_Button,$DirecctionA,"animatedModal5","Form","Edu_Tipo_Privacidad_Crud"),$ButtonAdicional
				);	
		        $Form1 = BFormVertical("Edu_Tipo_Privacidad_Crud",$Class,$Id_Edu_Tipo_Privacidad,$PathImage,$Combobox,$Buttons,"Id_Edu_Tipo_Privacidad");
            ...
            case "DeleteMassive":
				...
				$btn = "Continue ]" .$UrlFile ."/REDIRECT/".$Redirect."/Process/DELETE/Id_Edu_Tipo_Privacidad/".$Id_Edu_Tipo_Privacidad."/Obj/Edu_Tipo_Privacidad_Crud]animatedModal5]HXMS]]btn btn-default dropdown-toggle]}";				
	...
	public function ObjectDelete($Settings) {
		...
		$Id_Edu_Tipo_Privacidad = $Settings["Id_Edu_Tipo_Privacidad"];
			
		$where = array('Id_Edu_Tipo_Privacidad' =>$Id_Edu_Tipo_Privacidad);
		$rg = ClassPDO::DCDelete('edu_tipo_privacidad', $where, $Conection);
