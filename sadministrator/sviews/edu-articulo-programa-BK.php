        ...
        switch ($Interface) {
            case "":
				...
				$Id_Perfil_Educacion = $Row->Id_Perfil_Educacion;
					...
					$Query="SELECT PC.Nombre,PC.Id_Programa_Cab,PC.Imagen_Programa FROM programa_alumno PA
					...
					foreach($Row AS $Field){
						...
						}else{ $Imagen_FIELD=$Imagen_Programa;}
						...
						$Card = '<div class="col-md-3">
								  <div class="c-product" style="Position:relative;">
										<a class="cp-img" style="background-image: url(/sadministrator/simages/articulo/'.$Imagen_FIELD.')" href="/sadministrator/edu-programa/Interface/begin/programa/'.$Url_Amigable.'/request/on">
										</a>
									  <div class="cp-content">
										  <div class="cp-title">
											'.$Nombre.'
