...
class Edu_Notificacion_Actividades{
    ...
    public  function __construct($Parm=null)
	{
        ...
        switch ($interface) {
            ...
            case "Crea_Objeto_Evaluativo":
				...
				// echo $Id_Edu_Objeto_Evaluativo_Grupo;
				...
				if( $Estado !== "Finalizado" ){
					...
					if($Id_Edu_Tipo_Objeto_Evaluativo == 3){
						$btn = " Desarrollar Tarea ]" .$UrlFile_Tarea ."/interface/List".$urlLinkB."]PanelA]HXM]]btn btn-info}";				
						$Button = DCButton($btn, 'botones1', 'sys_form_evaluacion');	
						
				    }elseif($Id_Edu_Tipo_Objeto_Evaluativo == 4){
						
						$btn = " Participar del Foro ]" .$UrlFile_Foro ."/interface/List".$urlLinkB."/request/on/]]HREF]]btn btn-info}";				
						$Button = DCButton($btn, 'botones1', 'sys_form_evaluacion');	
				...
				// if( $Count_Obj_Evaluacion == $Evaluaciones_Desarrolladas ){
					...
					// if( $Entity == 3 || $Entity == 7 ){
						...
						// $Id_Edu_Gestion_Certificado = $Row->Id_Edu_Gestion_Certificado;
							...
							// 'Fecha_Fin' =>  $DCTimeHour,
							// 'Fecha_Inicio' =>  $DCTimeHour,
