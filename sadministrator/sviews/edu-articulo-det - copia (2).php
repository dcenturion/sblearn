...
class Edu_Articulo_Det{
    ...
    public  function __construct($Parm=null)
	{
				...
				// PROCESO CONFIGURAR -- EVALUACION
					...
					case "Edu_Componente_Articulo_B_Crud":
					        ...
					        if($Obj == "Edu_Componente_Doc_Crud" ){
								...
								$TipoEmbebido = $Parm["TipoEmbebido"];
								if( !empty( $TipoEmbebido) ){
									$Id_Edu_Formato = 7;
								}else{
								    $Id_Edu_Formato = 3;
								}
        ...
        switch ($interface) {
            ...
            case "y":
			    ...
			    if($Id_Edu_Formato == 7){			
				    $Contenido_Embebido_Kaltura = $Contenido_Embebido;
				}else{
			     	$Contenido_Embebido = trim($Contenido_Embebido);				
				}
                // $NombreComponente = $NombreComponente . " :: ".$Id_Edu_Formato;
				...
				}elseif($Id_Edu_Formato == 7){
					
					$ReproductorYT =  $Contenido_Embebido_Kaltura;	
					// $style = "style=margin-top:-19px;";
            ...
            case "Create_Conten_SubItem":
             ...
             case "Create_Conten_Kaltura":
				...
				$DirecctionA = $UrlFile."/Process/ENTRY/Obj/Edu_Componente_Embebido_Crud/key/".$key."/TipoEmbebido/Kaltura/Id_Edu_Componente_S/".$Id_Edu_Componente_S.$Id_Edu_Componente_Jerar_Url."/Id_Edu_Componente/".$Id_Edu_Componente."";
				$DirecctionDelete = $UrlFile."/interface/DeleteMassive/Id_Edu_Componente/".$Id_Edu_Componente;
				 ...
				 <tr>
					...
					<td class="c-link" style="width:90%;">
					  ';
						...
						}elseif($Field->Id_Edu_Formato == 3 || $Field->Id_Edu_Formato == 7){
	...
	public function MenuLocal($Id_Edu_Articulo,$Id_Edu_Almacen,$Id_Edu_Componente_S,$Perfil) {
		...
		if($Perfil == 1 || $Perfil == 2 || $Perfil == 777){
			...
			$listMn .= "<i class='zmdi zmdi-collection-video zmdi-hc-fw'></i> Vídeo Embebido Kaltura [".$UrlFile."/interface/Create_Conten_Kaltura/key/".$Id_Edu_Almacen."/Id_Edu_Componente_S/".$Id_Edu_Componente_S."[animatedModal5[HXM[{";					
