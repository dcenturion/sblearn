    ...
    public  function __construct($Parm=null)
	{
        ...
        switch ($Process) {
            case "ENTRY":
				...
				switch ($Obj) {
					...
					case "Pedido_Det_Crud":
					
							$Data = array();
							$Data['Id_Pedido_Cab'] = $Parm["Id_Pedido"];						
							$Data['Total'] = DCPost("Cantidad") * DCPost("Precio");						
						    DCCloseModal();									
							DCSave($Obj,$Conection,$Parm["Id_Pedido_Det"],"Id_Pedido_Det",$Data);  
							
							$Settings["Interface"] = "Details";
							$Settings["Id_Pedido"] = $Parm["Id_Pedido"];
							new PedidoCab($Settings);
							DCExit();	
							
						break;	

		            case "pedido_cab_crud":
							
							$Data = array();
							$Data['Estado'] = "Pendiente";						
							// $Data['Total'] = DCPost("Cantidad") * DCPost("Precio");						
						    DCCloseModal();									
							$Result = DCSave($Obj,$Conection,$Parm["Id_Pedido"],"Id_Pedido_Cab",$Data);  
							$Id_Pedido = $Result["lastInsertId"];
							
							// $Id_Pedido = $this->ObjectEntry($Id_Cliente);							
							
							if($Redirect == "pedido_cab"){
        ...
        switch ($Interface) {
            case "":
				...
				$DCPanelTitle = DCPanelTitle("TOOLS","Adminitrator of Objects skeditor uu",$btn);
