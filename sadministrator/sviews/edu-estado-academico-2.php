...
class Edu_Estado_Academico{
    ...
    public  function __construct($Parm=null)
	{
		...
		$UrlFile = "/sadministrator/edu-estado-academico";
        ...
        switch ($interface) {
            ...
            case "List":
				...
				$Query = "
				    SELECT PB.Id_Edu_Estado_Academico AS CodigoLink, PB.Nombre, PB.Alias, PB.Date_Time_Creation FROM edu_estado_academico PB
				";    
				$Class = 'table table-hover';
				$LinkId = 'Id_Edu_Estado_Academico';
            ...
            case "Create":
	            ...
	            $Id_Edu_Estado_Academico = $Parm["Id_Edu_Estado_Academico"];
				$DirecctionA = $UrlFile."/Process/ENTRY/Obj/Edu_Estado_Academico_Crud/Id_Edu_Estado_Academico/".$Id_Edu_Estado_Academico;
				$DirecctionDelete = $UrlFile."/interface/DeleteMassive/Id_Edu_Estado_Academico/".$Id_Edu_Estado_Academico;
				
				if(!empty($Id_Edu_Estado_Academico)){
				    $Name_Interface = "Editar Componente";				    	
				    $Name_Button = "<i class='zmdi zmdi-check zmdi-hc-fw'></i> Actualizar";
                    $ButtonAdicional = array("<i class='zmdi zmdi-delete zmdi-hc-fw'></i> Eliminar",$DirecctionDelete,"animatedModal5","Form","Edu_Estado_Academico_Crud","btn btn-default m-w-120");					
				}else{
				...
				$Buttons = array(
				     array($Name_Button,$DirecctionA,"animatedModal5","Form","Edu_Estado_Academico_Crud"),$ButtonAdicional
				);	
		        $Form1 = BFormVertical("Edu_Estado_Academico_Crud",$Class,$Id_Edu_Estado_Academico,$PathImage,$Combobox,$Buttons,"Id_Edu_Estado_Academico");
            ...
            case "DeleteMassive":
				...
				$btn = "Continue ]" .$UrlFile ."/Process/DELETE/Id_Edu_Estado_Academico/".$Id_Edu_Estado_Academico."/Obj/Edu_Estado_Academico_Crud]animatedModal5]HXMS]]btn btn-default dropdown-toggle]}";				
	...
	public function ObjectDelete($Settings) {
		...
		$Id_Edu_Estado_Academico = $Settings["Id_Edu_Estado_Academico"];
			
		$where = array('Id_Edu_Estado_Academico' =>$Id_Edu_Estado_Academico);
		$rg = ClassPDO::DCDelete('edu_estado_academico', $where, $Conection);
